...
.bodys button {
 ...
 <body>
 	...
 	<form class="searchbox" action='user' method='POST'>
		<div id="navcontainer">
			<ul id="navlist">
				<li id="active"><a href="adminItemsBought.jsp" id="current">User items bought</a></li>
							<li><a href="adminUserCartHistory.jsp">Items removed from his cart</a></li>
			</ul>
		</div>
	</form>
	<%} %>
	<table>
				<table align="center" style="text-align: center;" width="80%" border="0">
					...
					<br>
			<center><table>
			<%if (!user.get(searchname, 3).equals("a")) { 
				if (Integer.parseInt(user.get(searchname, 12))== 0) {%>
				<form action='banUser' method='POST'>
				<button style="width: 150px; height: 30px" type="submit" name="ban" value="yes">Ban The User</button>
				</form>
			<% } } %>
	</table></center>
	</td>
